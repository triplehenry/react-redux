    ...
    return function wrapWithConnect(WrappedComponent) {
      ...
      function makeChildElementSelector() {
        ...
        return function selectChildElement(childProps, forwardRef) {
          if (childProps !== lastChildProps || forwardRef !== lastForwardRef) {
            ...
            lastChildElement = /*#__PURE__*/React__default.createElement(FinalWrappedComponent, _extends({}, childProps, {
              ref: forwardRef
            }));
          }
      ...
      var Connect = /*#__PURE__*/function (_OuterBaseComponent) {
        ...
        function Connect(props) {
          ...
          _this.renderWrappedComponent = _this.renderWrappedComponent.bind(_assertThisInitialized(_this));
          return _this;
        }
        ...
        _proto.render = function render() {
          ...
          return /*#__PURE__*/React__default.createElement(ContextToUse.Consumer, null, this.renderWrappedComponent);
        };
      ...
      if (forwardRef) {
        var forwarded = React__default.forwardRef(function forwardConnectRef(props, ref) {
          return /*#__PURE__*/React__default.createElement(Connect, {
            wrapperProps: props,
            forwardedRef: ref
          });
        });
