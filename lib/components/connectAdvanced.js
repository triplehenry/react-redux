  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    function makeChildElementSelector() {
      ...
      return function selectChildElement(childProps, forwardRef) {
        if (childProps !== lastChildProps || forwardRef !== lastForwardRef) {
          ...
          lastChildElement = /*#__PURE__*/_react["default"].createElement(FinalWrappedComponent, (0, _extends2["default"])({}, childProps, {
            ref: forwardRef
          }));
        }
    ...
    var Connect = /*#__PURE__*/function (_OuterBaseComponent) {
      ...
      function Connect(props) {
        ...
        _this.renderWrappedComponent = _this.renderWrappedComponent.bind((0, _assertThisInitialized2["default"])(_this));
        return _this;
      }
      ...
      _proto.render = function render() {
        ...
        return /*#__PURE__*/_react["default"].createElement(ContextToUse.Consumer, null, this.renderWrappedComponent);
      };
